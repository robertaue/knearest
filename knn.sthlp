...
{pstd}{it:x1,x2,..} is a list of variables (a {it:varlist}) containing the coordinates of the data points. 
...
{p 4 4}
{inp: clear}  {break}
{inp: set obs 10} {break}
{inp: gen x1 = runiform()} {break}
{inp: gen x2 = runiform()} {break}
{inp: knn x1 x2, k(2) kni(kni_) knd(knd_)} {break}

{title:See also}

{cmd:knn()}: the underlying Mata routine, for more flexible use cases: {cmd:{help mf_knn:knn()}}
